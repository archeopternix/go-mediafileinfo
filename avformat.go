...
type AVCodecParameters struct {
	//	CodecType          AVMediaType  // General type of the encoded data.
	//	CodecID            AV_CODEC_ID  // Specific type of the encoded data (the codec used).
	...
	//	FieldOrder         AVFieldOrder // Video only.
	//	ColorRange         AVColorRange // Video only.
